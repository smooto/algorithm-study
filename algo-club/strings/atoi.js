...
const stringA = "4193 with words";

function myAtoi(string) {
  // remove leading whitespace characters
  
  // iterate through string
    // if string[0] isn't a numerical digit or +/- sign, return 0
    // otherwise, iterate and store consecutive numerical values until another non-digit or +/- character is found
      // if stored number > 32-bit integer range, return INT_MIN (−231)
}
